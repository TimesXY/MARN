...
if __name__ == '__main__':
    ...
    # 设置路径
    target_category = 1
    img_path = "D:\\MyDataSet\\初始数据\\lesion\\"
    model_weight_path = "save_weights/best_model.pth"

    # 建立模型
    model = ResNeXt(Bottleneck, [3, 4, 6, 3], num_classes=2, groups=32, width_per_group=4)
    ...
    for file_name in os.listdir(img_path):
        ...
        plt.savefig("D:\\MyDataSet\\初始数据\\lesion\\" + file_name[:-4] + "_CAM.jpg")
